                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="input-effect">
                                ...
                                <input class="primary-input form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                    ...
                                    type="text" name="name" id="name" placeholder=" @lang('lang.Enter_your') @lang('lang.name')" autocomplete="off" value="{{old('name')}}">
                            ...
                            <div class="input-effect mt-30">
                                ...
                                <input oninput="emailCheck(this)" class="primary-input form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"  placeholder="@lang('lang.Enter_your') @lang('lang.email')"  autocomplete="off" type="text" id="email" name="email" value="{{old('email')}}">
                            ...
                            <div class="input-effect mt-30">
                                ...
                                <input class="primary-input form-control{{ $errors->has('subject') ? ' is-invalid' : '' }}" placeholder="@lang('lang.enter') @lang('lang.subject')" autocomplete="off" type="text" id="subject" name="subject" value="{{old('subject')}}">
                            ...
                            <div class="input-effect mt-30 mb-10">
                                ...
                                <textarea class="primary-input form-control"  placeholder="@lang('lang.enter') @lang('lang.message') " autocomplete="off" name="message" id="message" cols="0" rows="4">{{old('email')}}</textarea>
