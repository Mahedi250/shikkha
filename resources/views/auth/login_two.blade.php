...
if(isset($setting->copyright_text)){ generalSetting()->copyright_text = $setting->copyright_text; }else{ generalSetting()->copyright_text = 'Copyright © 2022 All rights reserved by Shikkha App | Powered by <a href="https://sourcecodeltd.com.bd/en/">Source Code LTD</a>'; }
		...
		<div class="container">
			...
			<div class="row justify-content-center d-block d-md-block">
				<div class="col-lg-12 text-center">
					<p  style="margin-top: 25px !important;">Copyright © 2022 All rights reserved by <a href="https://shikkhaapp.com/">Shikkha App</a> | Powered by <a href="https://sourcecodeltd.com.bd/en/">Source Code LTD</a></p>
				</div>
			</div>
		</div> 
	</section> 
