        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <ul class="nav nav-tabs tab_column" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link @if (Session::get('smtp') == 'active' && Session::get('php') != 'active') active @endif" href="#smtp" role="tab" data-toggle="tab">Smtp @lang('lang.settings')</a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link @if (Session::get('smtp') != 'active' && Session::get('php') == 'active') active @endif" href="#php" role="tab" data-toggle="tab">Php @lang('lang.settings')</a>
                    </li>
                    </li>  
                </ul>
                <div class="tab-content">
                    <!-- Start Exam Tab -->
                    <div role="tabpanel" class="tab-pane fade @if (Session::get('smtp') == 'active' && Session::get('php') != 'active') show active @endif" id="smtp">
                    ...
                    <div role="tabpanel" class="tab-pane fade @if (Session::get('smtp') != 'active' && Session::get('php') == 'active') show active @endif" id="php">
                        @if(userPermission(446))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'method' => 'POST', 'url' => 'update-email-settings-data', 'id' => 'email_settings1', 'enctype' => 'multipart/form-data']) }}
                        @endif
                            <div class="row">
