                                ...
                                @foreach($payment_methods as $payment_method)
                                    <div class="CustomPaymentMethod">
                                        <div class="input-effect custom-transfer-account">
                                            <input type="radio" name="from_payment_method" data-id="{{$payment_method->id}}" id="from_method{{$payment_method->id}}" value="{{$payment_method->id}}" class="common-radio relation">
                                ...
                                @foreach($payment_methods as $payment_method)
                                    <div class="CustomPaymentMethod">
                                        <div class="input-effect custom-transfer-account remove{{$payment_method->id}}">
                                            <input type="radio" name="to_payment_method" data-id="{{$payment_method->id}}" id="to_method{{$payment_method->id}}" value="{{$payment_method->id}}" class="common-radio toRelation">
