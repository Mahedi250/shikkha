                                        ...
                                        <div class="col-lg-12"> 
                                            ...
                                            <div class="input-effect">
                                                ...
                                                <input class="primary-input form-control{{ @$errors->has('name') ? ' is-invalid' : '' }}"
                                                       ...
                                                       value="{{isset($classById)? @$classById->class_name: ''}}" required>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <input class="primary-input form-control{{ @$errors->has('fee') ? ' is-invalid' : '' }}"

                                                       type="text" name="fee" autocomplete="off" value="{{isset($classById)? @$classById->fee: ''}}" required>

                                              

                                                <label>Monthly Fee <span>*</span></label>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <input class="primary-input form-control{{ @$errors->has('admission_fee') ? ' is-invalid' : '' }}" type="text" name="admission_fee" autocomplete="off" value="{{isset($classById)? @$classById->admission_fee: ''}}" required>

                                              

                                                <label>Admission Fee <span>*</span></label>
                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                @foreach($classes as $class)
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">{{@$class->fee}}</td>
                                        <td valign="top">{{@$class->admission_fee}}</td>
