            ...
            <tbody>
                <tr align="center">
                    <td colspan="3">
                        ...
                        <h3><strong>@lang('lang.exam_has_to_be_submitted_within'): </strong>{{ @$take_online_exam->onlineExam!=""?@$take_online_exam->onlineExam->date:""}} {{@$take_online_exam->onlineExam!=""?@$take_online_exam->onlineExam->end_time:""}}</h3>
                    </td>
                </tr>
                <tr>
