                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    @if($already_add=="" && $balance_amount !=0)
                                                        ...
                                                        @if(@$data['bank_info']->active_status == 1 || @$data['cheque_info']->active_status == 1 )
                                                            ...
                                                            <a class="dropdown-item modalLink"
                                                               ...
                                                               href="{{route('fees-generate-modal-child', [@$balance_amount, $fees_assigned->student_id, $fees_assigned->feesGroupMaster->fees_type_id])}}"> @lang('lang.add') @lang('lang.bank') @lang('lang.payment')</a>
                                                    ...
                                                    @if(!empty($is_stripe) && $balance_amount !=0)
                                                        ...
                                                        <a class="dropdown-item modalLink" data-modal-size="modal-lg"
                                                           ...
                                                           href="{{route('fees-payment-stripe', [@$fees_assigned->feesGroupMaster->fees_type_id, $student->id, $balance_amount])}}">
