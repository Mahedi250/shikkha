                    ...
                    @isset($sidebars)  
                        ...
                        @foreach ($sidebars as $item)                       
                            ...
                            <li>
                                ...
                                @if(isset($item->menuName) && $item->menuName !== null && $item->menuName->parent_id == 0)
                            ...
                            <ul class="collapse list-unstyled" id="subMenuAdmin">
                                ...
                                @if(userPermission(394))
                                    ...
                                    <li>
                                        ...
                                        <a href="{{route('user_log')}}">Activity log</a>
                    ...
                    @endif
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="attendance">
                                <li><a href="{{ route('student.attendance.all') }}"> Today Attendance</a></li>
                            ...
                            <ul class="collapse list-unstyled" id="subMenuDormitory">
                                ...
                                @if(userPermission(367))
                                    ...
                                    <li>
                                        ...
                                        <a href="{{route('dormitory-list')}}"> Manage Hostel</a>
                                ...
                                @if(userPermission(363))
                                    ...
                                    <li>
                                        ...
                                        <a href="{{route('room-list')}}"> Room List</a>
                                ...
                                @if(userPermission(375))
                                    ...
                                    <li>
                                        ...
                                        <a href="{{route('student_dormitory_report')}}"> Hostel Member</a>
                            ...
                            <li>
                             ...
                             {{--        @if(userPermission(123))
                                   ...
                                   {{--  @if(userPermission(118))
                                    ...
                                    <!-- old menu -->
                                     {{--  <li><a href="{{route('collect_fees')}}"> old fees collect</a></li> --}}

                                    <!--new menu-->
                                    <li><a href="{{route('fees.collection')}}"> @lang('lang.collect_fees')</a></li>
                                    <li><a href="{{route('list.collection')}}"> Collection List</a></li>
                                    @endif
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="subMenusystemIDcard">
                                    ...
                                    {{-- <li>
                                        ...
                                        <a href="{{route('student-id-card')}}">Create ID Card Template</a>
                                    ...
                                    <li>
                                        ...
                                        <a href="{{route('generate_admit_card')}}">Generate Admit Card</a>
