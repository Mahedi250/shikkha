              ...
              <ul>
                ...
                <li>
                  ...
                  <p>
                    ...
                    @lang('lang.date'): {{ date('d-m-Y',strtotime(@$fees->payment_date)) }}
        ...
        <tbody>
             ...
             <!-- first td wrap  -->
                <td class="border-top">
                 @foreach($details as $row)	
                   @if($row->fees_type=='monthly')
                    <p> {{ date('F', strtotime('01-'.$row->fees_month.'-'.date('Y'))) }} </p>
                    @else
                	<p> {{ $row->fees_type }} </p>
                    @endif	
                 @endforeach 	
                  ...
                  <br>
                    <p><strong>@lang('lang.discount')(-)</strong></p>
                    <p> <strong>@lang('lang.fine')(+)</strong> </p>
                </td>
                ...
                <td class="border-top" style="text-align: right">
                	@foreach($details as $row)	
	                    <p>{{number_format($row->fees_type_amount, 2, '.', '')}} </p>
	                @endforeach
                	
                    <br>
                    {{number_format($fees->discount_amount, 2, '.', '')}} 
                    <br>
                    {{number_format($fees->fine, 2, '.', '')}}
          ...
          <tr>
            ...
            <td style="text-align: right">
              ...
              <strong>  {{ number_format((float) $fees->amount, 2, '.', '')}}   </strong>
