                ...
                <div class="white-box">
                    ...
                    <div class="">
                        ...
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-2">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input monthly_fee" type="text" name="monthly_fee" value="{{old('monthly_fee')}}">
                            ...
                            <!--student type-->
                             <div class="col-lg-2">
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('religion') ? ' is-invalid' : '' }}" name="student_type">
                                    ...
                                    <option value="General" @if(old('student_type')=='General') selected @endif selected>General</option>
                                    <option value="Full Free" @if(old('student_type')=='Full Free') selected @endif>Full Free</option>
                                    <option value="Half Free" @if(old('student_type')=='Half Free') selected @endif>Half Free</option>
                                </select>
                            </div>
                            <!--admission date-->
                             <div class="col-lg-2">
                       ...
                       <div class="col-lg-2" style="display:none;">
                        ...
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-6 text-right" style="display:none;">
                        ...
                        <div class="row mt-40" style="display:none;">
                         ...
                         <div class="row mb-40 mt-30" style="display:none;">
...
<script type="text/javascript">
    ...
    $("#classSelectStudent").change(function(){
      ...
      $.ajax({
           url: "{{ url("/get-details-class/") }}/"+id,
           type: 'get',
           success: function(data) {
                $('.monthly_fee').empty();
                $('.monthly_fee').val(data.fee);    
           }
        });
     });
</script>
