                ...
                <div class="white-box">
                    ...
                    <div class="">
                        ...
                        <div class="row mb-20">
                            ...
                            <div class="col-lg-2">
                             ...
                             <div class="col-lg-2">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input monthly_fee" type="text" name="monthly_fee" value="{{$student->monthly_fee}}">
                            ...
                            <!--student type-->
                             <div class="col-lg-2">
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('religion') ? ' is-invalid' : '' }}" name="student_type">

                                    <option data-display="Student Type" value="">Student Type</option>

                                    <option value="General" @if($student->student_type=='General') selected @endif selected>General</option>
                                    <option value="Full Free" @if($student->student_type=='Full Free') selected @endif>Full Free</option>
                                    <option value="Half Free" @if($student->student_type=='Half Free') selected @endif>Half Free</option>
                                </select>
                            </div>
                        ...
                        <div class="modal fade admin-query" id="editStudent" style="display:none;">
                        ...
                        <div class="parent_details" id="parent_details">
                            ...
                            <div class="row mb-20" style="display:none;">
                             ...
                             <div class="row mb-40" style="display:none;">
                       ...
                       <div class="row mt-40" style="display:none;">
                        ...
                        <div class="row mb-30 mt-30" style="display:none;">
                        ...
                        <div class="row mt-40 mb-4" style="display:none;">
                        ...
                        <div class="row mb-20 mt-40" style="display:none;">
