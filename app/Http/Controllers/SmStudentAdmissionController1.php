...
class SmStudentAdmissionController extends Controller
{
    ...
    public function studentStore(Request $request)
    {
        ...
        if ("s".$request->guardians_email != "") {
            $is_duplicate = SmStudent::where('school_id', Auth::user()->school_id)
                            ->where('email', "s".$request->guardians_email)
                            ->first();
        ...
        try {
            ...
            $user_stu->username = trim("S".$request->guardians_phone);
            $user_stu->email = "s".$request->guardians_email;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        $student->email ="";
                        $student->email = "s".$request->guardians_email;
                        ...
                        if ($student) {
                            $user_info[] =  array('email' => "s".$request->guardians_email, 'id' => $student->id, 'slug' => 'student');
                        }
