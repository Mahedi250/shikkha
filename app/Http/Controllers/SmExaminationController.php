        ...
        try {
            ...
            if ($exam_attendance == "") {
                ...
                if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                    ...
                    return ApiBaseMethod::sendResponse(null, 'Exam Attendance not taken yet, please check exam attendance');
                }
            ...
            if ($students->count() < 1) {
                if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                    ...
                    return ApiBaseMethod::sendResponse(null, 'Student is not found in according this class and section!');
                }
                ...
                if ($marks_entry_form->count() > 0) {
                    ...
                    if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                        ...
                        $data = ['students' => $students, 'exam_id' => $exam_id, 'class_id' => $class_id, 'section_id' => $section_id, 'subject_id' => $subject_id, 'subjectNames' => $subjectNames, 'number_of_exam_parts' => $number_of_exam_parts, 'marks_entry_form' => $marks_entry_form, 'exam_types' => $exam_types, 'search_info' => $search_info];
                        return ApiBaseMethod::sendResponse($data, 'data');
                    }
            ...
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                ...
                return ApiBaseMethod::sendResponse($e->getMessage(), 'data');
            }
...

    {
        ...
        try {
            ...
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                ...
                return ApiBaseMethod::sendResponse('marks added', 'data');
            }
...

    {
        ...
        try {
            ...
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                ...
                $data = ['exams' => $exams,  'students' => $students, 'exam_id' => $exam_id, 'subject_id' => $subject_id, 'class_id' => $class_id, 'section_id' => $section_id, 'exam_attendance_childs' => $exam_attendance_childs, 'search_info' => $search_info];
        ...
        try {
            ...
            try {
                ...
                if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                    ...
                    return ApiBaseMethod::sendResponse("Attendance store succesfully", null);
                }
                ...
                if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                    ...
                    return ApiBaseMethod::sendResponse($e->getMessage(), null);
                }
        ...
        try {
            ...
            if ($is_result_available->count() > 0) {
                ...
                if ($optional_subject == '') {
                    ...
                    return view(
                        'backEnd.reports.mark_sheet_report_normal_print',
                        [
