...
class SmSystemSettingController extends Controller
{
    ...
    public function emailSettings()
    {
        ...
        try {
            $editData = SmEmailSetting::where('email_engine_type','smtp')->first();
            $editDataPhp = SmEmailSetting::where('email_engine_type','php')->first();
    ...
    public function updateEmailSettingsData(Request $request)
    {
        ...
        try {
            ...
            try {
                $settings = SmEmailSetting::where('active_status', 1)->first();
