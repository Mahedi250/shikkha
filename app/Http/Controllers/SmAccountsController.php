...
class SmAccountsController extends Controller
{
    ...
    public function profit(Request $request)
    {
        try {
            ...
            $bank_balance=SmBankAccount::where('school_id',Auth::user()->school_id)
                        ->sum('current_balance');


            $total_income = $add_incomes + $bank_balance;
    ...
    public function fundTransferStore(Request $request){
        ...
        try{
            ...
            if($request->from_payment_method==3 && $request->from_bank_name==''){
                    ...
                    return redirect()->back();
            }elseif($request->to_payment_method==3 && $request->to_bank_name==''){
                    Toastr::error('Bank Name is Required', 'Error');
                    return redirect()->back();
            }
