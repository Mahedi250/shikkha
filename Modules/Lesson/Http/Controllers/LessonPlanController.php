...
class LessonPlanController extends Controller
{
    ...
    public function lessonPlannerSearch(Request $request){
        {
            ...
            try {
                $data = $this->loadDefault();	
                $user = Auth::user();
                $data['class_times'] = SmClassTime::where('academic_id', getAcademicId())->where('school_id', Auth::user()->school_id)->orderBy('period', 'ASC')->get();
    ...
    public function topicOverview(){
        try {
            $lessons=SmLesson::where('academic_id', getAcademicId())->where('school_id', Auth::user()->school_id)->get();
