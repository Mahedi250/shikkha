...
Route::prefix('lesson')->group(function() {
    ...
    Route::post('add-new-lesson-plan','LessonPlanController@addNewLessonPlan')->name('add-new-lesson-plan')->middleware('userRolePermission:811');
    ...
    Route::post('update-lesson-plan','LessonPlanController@updateLessonPlan')->name('update-lesson-plan')->name('lesson.lessonPlan-overiew')->middleware('userRolePermission:812');
    ...
    //for teacher
    Route::get('teacher/lessonPlan','Teacher\TeacherLessonPlanController@teacherLessonPlan')->name('view-teacher-lessonPlan')->middleware('userRolePermission:802');
   
    Route::get('teacher/lessonPlan-overview','Teacher\TeacherLessonPlanController@teacherLessonPlanOverview')->name('view-teacher-lessonPlan-overview')->middleware('userRolePermission:815');
    ...
    //Parents
    Route::get('parent/lessonPlan/{id}','Parent\ParentLessonPlanController@index')->name('lesson-parent-lessonPlan')->middleware('userRolePermission:810');
    Route::get('parent/lessonPlan-overview/{id}','Parent\ParentLessonPlanController@overview')->name('lesson-parent-lessonPlan-overview')->middleware('userRolePermission:815');
