(function ($) {
    ...
    $(document).on("click", ".generate-admit-card-print", function (event) {
    ...
    $(document).ready(function () {
        if ($("#edit_payment_method").val() == "3") {
            $("#edit_item_receive_bankAccount").show();
        } else {
            $("#edit_item_receive_bankAccount").hide();
        }
    });
    ...
    $(document).ready(function () {
        $("#itemReceivebankAccount").hide();
    });

    $(document).ready(function () {
        $("#item_receive_payment_method").on("change", function () {
            if ($(this).val() == "3") {
                $("#itemReceivebankAccount").show();
            } else {
                $("#itemReceivebankAccount").hide();
            }
        });
    ...
    $(document).ready(function () {
        $("#add_item_sell_bankAccount").hide();
    });

    $(document).ready(function () {
        $("#item_sell_payment_method_id").on("change", function () {
            if ($(this).val() == "3") {
                $("#add_item_sell_bankAccount").show();
            } else {
                $("#add_item_sell_bankAccount").hide();
            }
        });
