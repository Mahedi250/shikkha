(function($) {
    ...
    if (urlParam.includes("about") || urlParam.includes("contact") || urlParam.includes("course") || (urlParam.includes("news-page"))) {
        $(".banner-area").attr("style", "background: linear-gradient( 0deg, rgb(199 219 192 / 17%), rgb(0 0 0 / 29%)), url(public/uploads/about_page/about.jpg) no-repeat center !important;");
        $(".banner-content p").attr("style", "color:Black;");
        $(".banner-content h2").attr("style", "color:Black;");
    }
