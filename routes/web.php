...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::get('/noticeboard', function () {
        return view('frontEnd/home/lightnoticeboard');
    
          });
    Route::get('/notice-board/{id}', 'SmCommunicateController@viewnoticeid');
    Route::get('/governingbody', function () {
        return view('frontEnd/home/governingbody');
    
          });
    Route::get('/mission', function () {
            return view('frontEnd/home/missionvision');
        
              });
    Route::get('/message', function () {
                return view('frontEnd/home/message');
...
// Course Details route start
    ...
    Route::get('view-page/{slug}', 'SmFrontendController@viewPage')->name('view-page')->middleware('userRolePermission:655');
