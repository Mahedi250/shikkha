...
Route::group(['middleware' => ['XSS', 'subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        Route::get('get-details-class/{id}', ['as' => 'class_details', 'uses' => 'SmClassController@classDetails'])->middleware('userRolePermission:264');
        ...
        //__all new routes for collection__//

        Route::get('/fees-collection', 'SmFeesController@collectionFees')->name('fees.collection')->middleware('userRolePermission:109');
        Route::get('/fees-collection/{id}', 'SmFeesController@collectingFees')->name('fees.collecting')->middleware('userRolePermission:110');

        Route::get('fees/create/person/wise/row/{id}', 'SmFeesController@createPersonWiseRow');
        Route::get('check/month/for/fees/{month_id}/{student_id}/{year}', 'SmFeesController@checkMonthFees');
        Route::post('store/fees', 'SmFeesController@storeFees')->name('store.fees');

        Route::get('/list-collection', 'SmFeesController@collectionFeesList')->name('list.collection')->middleware('userRolePermission:109');
        Route::get('/delete/list/collection/{id}', 'SmFeesController@DeletecollectionFeesList')->name('delete.list.collection');
        Route::get('/view/single/fees/{id}', 'SmFeesController@viewSingleDetails');

        Route::get('/fees/collect/invoice', 'SmFeesController@InvoicePrint')->name('fees.collect.invoice');
        Route::get('/print/single/fees/{id}', 'SmFeesController@InvoicePrintSingle');
        ...
        //__feesmaster new routes__//
        Route::post('store-fees-master', 'SmFeesMasterController@storeFeesMaster')->name('store.fees_master')->middleware('userRolePermission:119');
        Route::get('delete-master-fees/{id}', 'SmFeesMasterController@DeleteMasterFees')->name('delete.master_fees')->middleware('userRolePermission:121');
        Route::get('edit/master/fees/{id}', 'SmFeesMasterController@EditMasterFees');
        Route::post('update-fees-master', 'SmFeesMasterController@updateFeesMaster')->name('update.fees_master')->middleware('userRolePermission:119');
        // Complaint
        ...
        Route::get('generate-admit-card', ['as' => 'generate_admit_card', 'uses' => 'SmStudentIdCardController@generateadmitCard'])->middleware('userRolePermission:57');
        ...
        Route::post('generate-admit-card-search', ['as' => 'generate_admit_card_search', 'uses' => 'SmStudentIdCardController@generateadmitCardSearch']);
        Route::get('generate-admit-card-search', ['as' => 'generate_admit_search', 'uses' => 'SmStudentIdCardController@generateadmitCard']);
        Route::get('generate-id-card-print/{s_id}/{c_id}', 'SmStudentIdCardController@generateIdCardPrint');
        Route::get('generate-admit-card-print/{s_id}/{c_id}', 'SmStudentIdCardController@generateAdmitCardPrint');
        ...
        Route::post('fetch-from-machine', 'SmStudentAttendanceController@Featchfrommachine')->name('fetch-from-machine');
    ...
    //__new attendance report generate__//
    Route::get('attendance-student', 'AttendanceController@StudentAttendance')->name('student.attendance');
    Route::get('attendance-student-print', 'AttendanceController@StudentAttendancePrint')->name('student.attendance.print');
    Route::get('attendance-teacher', 'AttendanceController@TeacherAttendance')->name('teacher.attendance');
    Route::get('attendance-teacher-print', 'AttendanceController@TeacherAttendancePrint')->name('teacher.attendance.print');
    Route::get('attendance-today', 'AttendanceController@AllstudentAttendancetoday')->name('student.attendance.all');
});
