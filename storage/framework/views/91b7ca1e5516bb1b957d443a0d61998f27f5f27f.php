...
<section style="padding: 10px;">
    <div class="container">
        <div class="row">
            <div class="EIIN">EIIN :<?php echo e($setting->school_code); ?> </div> <br> 
        <?php 
    //  dd($setting);
        ...
        <div class="hotline">Hotline: <?php echo e($setting->phone); ?></div>
    </div>
</section>
                    ...
                    <div class="home-notice-content">
                        <marquee behavior="" direction="up" scrollamount="2">
                            ...
                            <?php $__currentLoopData = $notice_board; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="notice-board/<?php echo e($notice->id); ?>">
            ...
            <div class="row mx-0">
                <div class="col-lg-12 p-0">
                    <div class="gallary-img videoImage">
                        <img src="<?php echo e($homePage->image); ?>" alt="" class="d-block w-100">
...
<?php echo $__env->make('frontEnd.home.front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/sikkha/resources/views/frontEnd/home/light_home.blade.php ENDPATH**/ ?>