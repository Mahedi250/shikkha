...
<nav class="navbar navbar-expand-lg up_navbar" id="main-nav-for-chat">
    <div class="container-fluid">
        ...
        <li data-position="">
            <a  class="primary-btn white  mr-10 liveClassTeacher" href="zoom/virtual-class">Live Class</a>
        </li>
        <script>
            var data = $(".main-title").html();
            if(data.includes("Teacher")){
                $(".liveClassTeacher").show();
            } else {
                $(".liveClassTeacher").hide();
            }
        </script>
...
<?php /**PATH /opt/lampp/htdocs/sikkha/resources/views/backEnd/partials/menu.blade.php ENDPATH**/ ?>