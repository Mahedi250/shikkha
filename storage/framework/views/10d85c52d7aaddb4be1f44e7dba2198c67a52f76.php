        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <ul class="nav nav-tabs tab_column" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link <?php if(Session::get('twilio_settings') != 'active' && Session::get('msg91_settings') != 'active' && Session::get('textlocal_settings') != 'active' && Session::get('africatalking_settings') != 'active'): ?> active <?php endif; ?>" href="#select_sms_service" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.select_a_SMS_service'); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if(Session::get('twilio_settings') == 'active'): ?> active <?php endif; ?> " href="#twilio_settings" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.twilio'); ?> <?php echo app('translator')->get('lang.settings'); ?></a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link <?php if(Session::get('msg91_settings') == 'active'): ?> active <?php endif; ?> " href="#msg91_settings" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.msg91'); ?> <?php echo app('translator')->get('lang.settings'); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if(Session::get('textlocal_settings') == 'active'): ?> active <?php endif; ?> " href="#textlocal_settings" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.textlocal'); ?> <?php echo app('translator')->get('lang.settings'); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if(Session::get('africatalking_settings') == 'active'): ?> active <?php endif; ?> " href="#africatalking_settings" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.africatalking'); ?> <?php echo app('translator')->get('lang.settings'); ?></a>
                    </li>  
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade <?php if(Session::get('twilio_settings') != 'active' && Session::get('msg91_settings') != 'active' && Session::get('textlocal_settings') != 'active' && Session::get('africatalking_settings') != 'active'): ?> show active <?php endif; ?>" id="select_sms_service">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                type="text" name="textlocal_username" autocomplete="off" value="<?php echo e(isset($sms_services)? @$sms_services[2]->textlocal_username : ''); ?>" id="textlocal_username">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                type="text" name="textlocal_hash" autocomplete="off" value="<?php echo e(isset($sms_services)? @$sms_services[2]->textlocal_hash : ''); ?>" id="textlocal_hash">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                type="text" name="textlocal_sender" autocomplete="off" value="<?php echo e(isset($sms_services)? @$sms_services[2]->textlocal_sender : ''); ?>" id="textlocal_sender">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                type="text" name="africatalking_username" autocomplete="off" value="<?php echo e(isset($sms_services)? @$sms_services[3]->africatalking_username : ''); ?>" id="textlocal_username">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                type="text" name="africatalking_api_key" autocomplete="off" value="<?php echo e(isset($sms_services)? @$sms_services[3]->africatalking_api_key : ''); ?>" id="africatalking_api_key">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sikkha\resources\views/backEnd/systemSettings/smsSettings.blade.php ENDPATH**/ ?>