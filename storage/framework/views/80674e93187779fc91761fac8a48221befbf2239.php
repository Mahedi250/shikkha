            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-title">
                        <h3><?php echo e($about->main_title); ?></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="quote-details">
                        <div class="quote-img">
                            <img src="<?php echo e($about->main_image); ?>" width="100%" height="300px" alt="">
                            <div class="details mt-4">
                                <p><?php echo e($about->main_description); ?></p>
                            </div>
...
<?php echo $__env->make('frontEnd.home.front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/sikkha/resources/views/frontEnd/home/light_about.blade.php ENDPATH**/ ?>