                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="whyChoose.html">Why Choose Us</a>
                            <a class="dropdown-item" href="message-from-chairman.html">Message</a>             
                            <a class="dropdown-item" href="governing-body.html">Governing Body</a>
                            <a class="dropdown-item" href="vision-and-objectives.html">Mission & Vision</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="co-curricular-activities.html">Co-curricular Activities</a>
                            <a class="dropdown-item" href="academic-calendar.html">Academic calendar</a>
                            <a class="dropdown-item" href="dress-code.html">Dress Code</a>
                            <a class="dropdown-item" href="lesson-plan.html">Lesson Plan</a>
                            <a class="dropdown-item" href="guideline-for-parents.html">Guideline for Parents</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link  dropdown-toggle " id="navbarDropdown" role="button" data-toggle="dropdown"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="AdmissionInfo.html">Admission Info</a>
                            <a class="dropdown-item" href="fees-payment.html">Fees & Payment</a>
                            <a class="dropdown-item" href="scholarships.html">Scholarships</a>
                            <a class="dropdown-item" href="transfer-procedures.html">Transfer Procedures</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link  dropdown-toggle " id="navbarDropdown" role="button" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="principaldetails.html">Principal</a>
                            <a class="dropdown-item" href="VCprincipal.html">V.C Principal</a>
                            <a class="dropdown-item" href="Teachersdetails.html">Teacher's</a>
                            <a class="dropdown-item" href="Exprincipal.html">Ex Principals</a>
                            <a class="dropdown-item" href="Officestaff.html">Office Staff</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link  dropdown-toggle " id="navbarDropdown" role="button" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="video-gallary.html">Video Gallary </a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link  dropdown-toggle " id="navbarDropdown" role="button" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="employment-circulars.html">Employment Circulars‌</a>
                            <a class="dropdown-item" href="recruitment-exam-results.html">Recruitment Exam Results</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="suborno-video-gallery.html">ভিডিও গ্যালারী</a>
                        </div>
                    </li>
                    <?php if(!auth()->check()): ?>
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <div class="copyright">
                        <p>© Copyright 2022 , All Rights Reserved<br>Powered by Shikkha App Demo, A product of <a
                                href="https://addiesoft.com/">Source Code Ltd</a></p>
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\sikkha\resources\views/frontEnd/home/front_master.blade.php ENDPATH**/ ?>